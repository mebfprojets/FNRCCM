  ...
  _updateUIState: function Toolbar_updateUIState(resetNumPages) {
   ...
   if (resetNumPages) {
    if (this.hasPageLabels) {
     ...
     items.numPages.textContent = mozL10n.get('of_pages', { pagesCount: pagesCount }, 'de {{pagesCount}}');
    }
...
var DEFAULT_URL = null /*'http://localhost/outils/pdf.js-gh-pages/web/compressed.tracemonkey-pldi-09.pdf'*/;
;
var pdfjsWebApp;
{
