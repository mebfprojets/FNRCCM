...
SIRAH.util.isObject    = function(obj){return Object.prototype.toString.call(obj) === '[object Object]';};
...
function disableButtons(buttons) {
	if( buttons instanceof jQuery || SIRAH.util.isObject(buttons)) {
		buttons = [ buttons ];
	}
	 jQuery.each(buttons , function(index , value){
		  if( SIRAH.util.isEmpty(value)) {
			  return;
		  }
		  if( value instanceof jQuery || SIRAH.util.isObject(value) ) {
			  value = value.attr("id");
		  }
