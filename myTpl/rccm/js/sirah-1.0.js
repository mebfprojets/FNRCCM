...
{	
	 ...
	 var defaultParams   = { data        : defaultData,
			                 ...
			                 error       : function(data){SIRAH.error.raise(formSelector , data ,"error");return data;},
...
function disableButtons(buttons) {
	jQuery.each(buttons , function(index , value){
		if( jQuery(this).attr("id")!==undefined || jQuery(this).attr("class")!==undefined) {
			jQuery(this).addClass('disabled').addClass('disabledLink').attr('disabled','disabled');
		    return;
		}
...
function enableButtons(buttons) {
	jQuery.each(buttons , function(index , value){
		if( jQuery(this).attr("id")!==undefined || jQuery(this).attr("class")!==undefined) {
			jQuery(this).removeClass('btn-disabled').removeClass('disabled').removeClass('disabledLink').removeAttr('disabled');
		    return;
		}
	    if(!SIRAH.util.isEmpty(jQuery('#'+value).attr('id'))){
