...
class Table_Demandes extends Sirah_Model_Table
{
    ...
    protected $dependentTables = array("Table_Demandereservations","Table_Demandeverifications","Table_Demandeverifications","Table_Demandedocuments","Table_Demanderequests");
