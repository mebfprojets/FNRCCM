...
class Plugin_Rbac extends Zend_Controller_Plugin_Abstract
{
	...
	public function preDispatch(Zend_Controller_Request_Abstract $request)
	{
		...
		$roleAcl        = Sirah_Fabric::getAcl("roleAcl", 0 , $user->getRole() );	
		...
		if( !$roleAcl->has( $controllerName ) && !$acl->has( $controllerName ) && $controllerName!="error" && $controllerName!="index" && $user->isLoggedIn() ) {
