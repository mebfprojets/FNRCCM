...
class Model_Project extends Sirah_Model_Default
{
	...
	{
		$params  = "nb_elements_page|20~default_year|'CURRENT'~default_period_start|0~default_period_end|0~
              		default_check_documents|1~default_find_documents|1~default_find_documents_src|'G:\BFRCCM'~
				    default_pdf_margins|0~default_pdf_header|''~default_pdf_footer|''~default_pdf_width|0~default_domaineid|1";
		return 	$params;		
	}
	...
	public function setParams($parametres=array())
	{
