...
class Model_Commandefacture extends Sirah_Model_Default
{
	...
	public function getList( $filters = array(),$pageNum=0,$pageSize=0, $orders=array("F.creationdate DESC","F.date DESC","C.date DESC"))
	{
		...
		$selectInvoices   = $dbAdapter->select()->from(    array("F" =>$tableName))
												...
												->join(    array("U" =>$tablePrefix."system_users_account"),  "U.userid=M.accountid"        , array("U.userid","U.lastname","U.firstname","U.email","U.username","U.avatar","U.phone1","U.phone2","U.sexe"))
												->join(    array("DM"=>$tablePrefix."reservation_demandeurs"),"DM.accountid=M.accountid"    , array("DM.demandeurid","DM.identityid"))
