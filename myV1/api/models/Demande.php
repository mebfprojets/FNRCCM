...
class Model_Demande extends Sirah_Model_Default
{
	...
	public function getList($filters=array(),$pageNum=1, $pageSize=10, $orders=array("R.creationdate DESC","R.date DESC","R.demandeid DESC"))
	{
		$modelTable     = $this->getTable();
		$dbAdapter      = $modelTable->getAdapter();
		$tablePrefix    = $modelTable->info("namePrefix");		
		...
		$selectDemandes = $dbAdapter->select()->from( array("R" => $tablePrefix."reservation_demandes"))
											  ...
											  ->join( array("E" => $tablePrefix."reservation_demandes_entreprises"),"E.demandeid=R.demandeid AND E.entrepriseid=R.entrepriseid AND E.denomination=R.denomination",array("E.nomcommercial","E.sigle","E.denomination","E.formid","E.address","E.activite","E.telephone","E.domaineid"))
		...
		if( isset($filters["sync_demandeid"]) &&  ($filters["sync_demandeid"]!==null) &&  ($filters["sync_demandeid"]!==false)) {
	...
	public function getListTest($filters=array(),$pageNum=0, $pageSize=0, $orders=array("R.expired ASC","R.date DESC","D.lastname ASC","D.firstname ASC"))
	{
		...
		$selectDemandes = $dbAdapter->select()->from(    array("R"=> $tablePrefix."reservation_demandes"))
											  ...
											  ->joinLeft( array("E"=> $tablePrefix."reservation_demandes_entreprises"),"E.demandeid=R.demandeid",array("E.nomcommercial","E.sigle","E.denomination","E.formid","E.address","E.activite","E.telephone","E.domaineid"))
    ...
    public function getListPaginator($filters = array())
	{
		...
		$selectDemandes   = $dbAdapter->select()->from(array("R"=> $tablePrefix."reservation_demandes"), array("R.demandeid"))
		                                        ->join(array("P"=> $tablePrefix."reservation_promoteurs")          ,"P.promoteurid=R.promoteurid",null)
		                                        ->join(array("D"=> $tablePrefix."reservation_demandeurs")          ,"D.demandeurid=R.demandeurid",null)
												->join(array("E"=> $tablePrefix."reservation_demandes_entreprises"),"E.demandeid=R.demandeid AND E.entrepriseid=R.entrepriseid AND E.denomination=R.denomination",null);
