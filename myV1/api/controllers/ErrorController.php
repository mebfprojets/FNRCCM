...
/**
 * Ce fichier est une partie de la librairie de SIEMBF
 *
...
class Api_ErrorController extends Sirah_Controller_Default
{
			...
			case Zend_Controller_Plugin_ErrorHandler::EXCEPTION_OTHER :
				switch (get_class($this->_errorHandler->exception)) {
					...
					default :
						self::$httpCode        = 506;
						self::$errorViewTitle  = " Erreurs Techniques du système ";
						self::$errorMessage    = " Une erreur  s'est produite dans l'exécution de votre requete. 
						                           Nous nous excusons du désagrement et vous promettons d'y apporter une solution dans de brefs délai. ";
						break;
				}
				break;
