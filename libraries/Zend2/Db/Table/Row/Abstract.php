...
abstract class Zend_Db_Table_Row_Abstract implements ArrayAccess, IteratorAggregate
{
    ...
    public function __get($columnName)
    {
        ...
        if (!array_key_exists($columnName, $this->_data)) {
            ...
            require_once 'Zend/Db/Table/Row/Exception.php';
            throw new Zend_Db_Table_Row_Exception("Specified column \"$columnName\" is not in the row from {$tableName} ");
        }
    ...
    public function __set($columnName, $value)
    {
        ...
        if (!array_key_exists($columnName, $this->_data)) {
            require_once 'Zend/Db/Table/Row/Exception.php';
            throw new Zend_Db_Table_Row_Exception("La colonne specifiee  \"$columnName\" n'est pas dans la ligne ");
        }
