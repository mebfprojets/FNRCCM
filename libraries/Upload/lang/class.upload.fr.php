 ...
 */
    ...
    $translation['local_file_not_readable']     = 'Le fichier local ne peut etre ouvert en lecture.';
    $translation['uploaded_too_big_ini']        = 'Le fichier transmis dépasse la taille autorisée dans la configuration .';
    ...
    $translation['uploaded_missing']            = 'Le serveur n\'a pas recu de fichier.';
    ...
    $translation['no_mime']                     = 'Le Format MIME type ne peut etre détecté.';
    ...
    $translation['already_exists']              = '%s existe déja . Changez le nom du fichier.';
    ...
    $translation['destination_dir']             = 'Le répertoire de destination ne peut Ãªtre crée. Impossible de continuer.';
    ...
    $translation['destination_dir_write']       = 'Le répertoire de destination ne peut etre ouvert en écriture. Impossible de continuer.';
    $translation['destination_path_write']      = 'Le chemin de destination ne peut Ãªtre ouvert en écriture. Impossible de continuer.';
    $translation['temp_file']                   = 'Le fichier temporaire ne peut Ãªtre crée. Impossible de continuer.';
    $translation['source_not_readable']         = 'Le fichier source ne peut Ãªtre lu. Impossible de continuer.';
    ...
    $translation['gd_missing']                  = 'GD ne semble pas Ãªtre présent.';
    $translation['watermark_no_create_support'] = 'Création depuis un fichier %s impossible, watermark ne peut Ãªtre lu.';
