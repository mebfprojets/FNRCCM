    ...
    implements Iterator, Countable
{
    ...
    public function table(array $attributes = null)
    {
    	...
    	if( null ==  $table->view ){
    		 $table->view  = Zend_Layout::getMvcInstance()->getView();
    	}
        return $table;
    }
     ...
     *
     * @param  array $rowAttributes les attributs de la ligne
     * @return Twitter_Bootstrap_Tables_Table_Row
     */
    public function row($rowAttributes = array())
    {
        return $this->view->row($rowAttributes);
    }
     ...
     * Adds a table foot
     *
     * @param string $tableFoot
     */
    public function setFoot(Twitter_Bootstrap_Tables_Table_Row $tableFoot)
    {    
    	$this->_foot = $tableFoot;
    }
    ...
    public function __toString()
    {
        ...
        if (null !== $this->_foot) {
        	$content .= sprintf('<tfoot>%s</tfoot>', $this->_foot);
        }
