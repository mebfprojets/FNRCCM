...
class Sirah_Validateur_Username extends Zend_Validate_Abstract
{
  ...
  protected $_messageTemplates = array(      
                                       self::TROP_LONG        =>  "Votre identifiant '%value%' est trop long, il ne doit pas depasser '%max%'  caracteres ",
                                       self::TROP_COURT       =>  " Votre identifiant '%value%' est trop court, il doit contenir au minimum '%min%' caracteres ",
                                       self::CARACTER_INVALID =>  " Votre identifiant '%value%'  contient un caractere invalide : '%invalid%',les caracteres speciaux sont interdits ");
