...
class Sirah_View_Helper_Buttonsbar_Buttons extends Sirah_View_Helper_Toolsbar_Tools
{
	
	/**
	 * @var boolean
	 */
	public static $priorities = array("primary","secondary");
	 ...
	 */
	public function buttons( $labelValue, $glyphicon , $eventHandler = null , $attributes = array())
	{
		$button = new static();
