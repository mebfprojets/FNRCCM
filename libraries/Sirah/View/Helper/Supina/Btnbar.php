 ...
 */
  ...
  class Sirah_View_Helper_Supina_Btnbar extends Sirah_View_Helper_HtmlElement implements Iterator, Countable
  {
  	
  	public function btnbar( $attributes = array() , $eventHandler = null ) 
  	{
  		$button = new static();
  	...
  	public function button($label, $icon = null, $eventHandler = null)
  	{
  		...
  		return $this->view->btn( $label , $icon , $eventHandler);
  	}
  	 ...
  	 * @param string $id
  	 */
  	public function add( Sirah_View_Helper_Supina_Btn $button , $id = null)
  	{
  		if(( null !== $id ) && !empty($id)){
  			$button->setId($id) ;
