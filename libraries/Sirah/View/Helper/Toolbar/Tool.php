...
class Sirah_View_Helper_Toolbar_Tool extends Sirah_View_Helper_HtmlElement
{
	...
	public static  $icons  =  array(
        ...
        'comment', 'copy','download', 'download-alt', 'edit',
        ...
        'time', 'tint', 'transfer' , 'trash', 'upload','unlock','unchecked',
	 ...
	 */
	public function tool($labelValue, $icon , $eventHandler = null , $attributes = array())
	{
		$tool = new static();
